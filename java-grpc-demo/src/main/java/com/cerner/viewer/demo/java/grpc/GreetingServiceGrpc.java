...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.cerner.viewer.demo.java.grpc.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.cerner.viewer.demo.java.grpc.HelloRequest,
      com.cerner.viewer.demo.java.grpc.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = com.cerner.viewer.demo.java.grpc.HelloRequest.class,
      responseType = com.cerner.viewer.demo.java.grpc.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.cerner.viewer.demo.java.grpc.HelloRequest,
      com.cerner.viewer.demo.java.grpc.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<com.cerner.viewer.demo.java.grpc.HelloRequest, com.cerner.viewer.demo.java.grpc.HelloResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod = 
              io.grpc.MethodDescriptor.<com.cerner.viewer.demo.java.grpc.HelloRequest, com.cerner.viewer.demo.java.grpc.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.cerner.viewer.demo.java.grpc.GreetingService", "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cerner.viewer.demo.java.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cerner.viewer.demo.java.grpc.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(com.cerner.viewer.demo.java.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.cerner.viewer.demo.java.grpc.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.cerner.viewer.demo.java.grpc.HelloRequest,
                com.cerner.viewer.demo.java.grpc.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.cerner.viewer.demo.java.grpc.HelloResponse greeting(com.cerner.viewer.demo.java.grpc.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.cerner.viewer.demo.java.grpc.HelloResponse> greeting(
        com.cerner.viewer.demo.java.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((com.cerner.viewer.demo.java.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.cerner.viewer.demo.java.grpc.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.cerner.viewer.demo.java.grpc.ExampleService.getDescriptor();
    }
